...
from .views import IndexView, FullScreenIndexView, DetailView, ResolveView, RecheckView, SilenceClientView, SilenceCheckView
...
urlpatterns = patterns('',
    ...
    url(r'^events/(?P<check>[\w\_\.]+)/(?P<client>[\w\.\-]+)/recheck/$', RecheckView.as_view(), name='recheck'),
